...
class BaseUbl(models.AbstractModel):
    ...
    #def _ubl_get_party_identification(self, commercial_partner, partner, company, node_name, parent_node, ns, version = "2.1"):
        """This method is designed to be inherited in localisation modules
        Should return a dict with key=SchemeName, value=Identifier"""
        #CustomerAssignedAccountID = etree.SubElement(parent_node, ns["cbc"] + "CustomerAssignedAccountID")   # milan
        #CustomerAssignedAccountID.text = ""      #milan
        return {}
# U srpskoj verziji dodat broj JBKS
...
# Ovde je dodat tag deliveri u srpskoj verziji
